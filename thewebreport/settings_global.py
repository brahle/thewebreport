"""
Shared Django settings for project thewebreport.
...
ROOT_URLCONF = 'thewebreport.urls'

WSGI_APPLICATION = 'thewebreport.wsgi.application'
...
STATIC_ROOT = '/var/twr/virtualenv/static/'
